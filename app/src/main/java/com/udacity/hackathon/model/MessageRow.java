...
import static com.udacity.hackathon.Config.MSG_CONTENT;
import static com.udacity.hackathon.Config.MSG_SENDER;
import static com.udacity.hackathon.Config.MSG_TIME;


public class MessageRow implements Parcelable {
    private final static String TAG = MessageRow.class.getSimpleName();
